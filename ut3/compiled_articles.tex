...
\author{Lucas Eduardo Jaguzewski da Silva (UFPR, Parana, Brazil)
\date{\today}
\maketitle
...
\renewcommand{\abstracttextfont}{\normalfont}
  ...
  Lucas Eduardo Jaguszewski da Silva\thanks{Correspondence: lucasjaguszewski@example.com}, 
  ChatGPT (OpenAI), 
  DeepSeek \\
  Independent Researcher \\
  Programming and AI Applications Lab \\
  OpenAI, San Francisco, CA, USA \\
  DeepSeek AI, City, Country
}
\date{\today}
...
\date{Institute for Advanced Study, Princeton, USA\\
Stanford University, California, USA\\
*Correspondence: jane.doe@ias.edu}
...
\SetWatermarkScale{0.8}
  ...
  Lucas Eduardo Jaguszewski da Silva, 
  Community Contributors \\
  GitHub: \url{https://github.com/QuantumReactor-r1} \\
  Join at \url{https://github.com/QuantumReactor-r1}
}
\date{\today}
...
\renewcommand{\abstracttextfont}{\normalfont}
  ...
  ChatGPT (OpenAI)
  \\
  Department of Physics, University X, City, Country \\
  Independent Researcher, City, Country \\
  Programming and AI Applications Lab, Institution Y, City, Country \\
  OpenAI, San Francisco, CA, USA
}
\date{\today}
